...
# module load stack/2024-06 gcc/12.2.0 netcdf-c/4.9.2
source .env
...
# NUM_SNAPSHOTS=10
python3 scripts/process.py ./data/$MODEL/$DATASET/_dataset.nc  --output_file ./data/$MODEL/$DATASET/_processed.nc --config_file ./data/$MODEL/$DATASET/_config.json
# python3 scripts_old/process-camlab.py 
#--- Analysis
...
# cd /cluster/scratch/vogtva/data/gray_scott/gs_final/
# module load stack/2024-06  gcc/12.2.0  openmpi/4.1.6 nco/5.1.6
# ncks -d snapshot,0,-2 _dataset.nc _dataset_trunc_time.nc